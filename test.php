<html>
	...
	<body>
		...
		<div id="main">
            ...
            print "					<th><h2><br/>Recruiters</h2></th>\n";
            print "					<td>\n";
            print "					<a href=\"https://sites.google.com/a/evanschambers.com/ec-recruiting/\">\n";
            print "					<div id=\"ec_recruiting_logo\" class=\"icon_bg\"></div>\n";
            print "					<p>Recruiting Site</p>\n";
            print "					</a>\n";
            print "					</td>\n";
            print "					<td>\n";
            print "					<a href=\"https://source.jobvite.com/TalentNetwork/common/sso.html?from=google&stage=discovery&domain=evanschambers.com\">\n";
            print "					<div id=\"jobvite_logo\" class=\"icon_bg\"></div>\n";
            print "					<p>Jobvite</p>\n";
            print "					</a>\n";
            print "					</td>\n";
            print "					<td>\n";
            print "					<a href=\"http://hiring.monster.com/\">\n";
            print "					<div id=\"monster_logo\" class=\"icon_bg\"></div>\n";
            print "					<p>Monster</p>\n";
            print "					</a>\n";
            print "					</td>\n";
            print "					<td>\n";
            print "					<a href=\"https://ccesc2.gdit.com/dana-na/auth/url_28/welcome.cgi\">\n";
            print "					<div id=\"i2s_logo\" class=\"icon_bg\"></div>\n";
            print "					<p>GD i2S Portal</p>\n";
            print "					</a>\n";
            print "					</td>\n";
            print "					<td>\n";
            print "					<a href=\"\" onclick=\"alert('URL not yet added'); return false;\"\n";
            print "					<div id=\"referrals_admin_logo\" class=\"icon_bg\"></div>\n";
            print "					<p>Referrals Admin</p>\n";
            print "					</a>\n";
            print "					</td>\n";
            print "					<td>\n";
            print "					 \n";
            ...
            print "					<tr>";
              ...
              print "					<th><h2>Business<br/>Managers</h2></th>\n";
              print "					<td>\n";
              print "					<a href=\"https://sites.google.com/a/evanschambers.com/ec-business-development/\">\n";
              print "					<div id=\"ec_bd_logo\" class=\"icon_bg\"></div>\n";
              print "					<p>BD Site</p>\n";
              print "					</a>\n";
              print "					</td>\n";
              print "					<td>\n";
              print "					<a href=\"https://ectech.basecamphq.com/clients\">\n";
              print "					<div id=\"basecamp_logo\" class=\"icon_bg\"></div>\n";
              print "					<p>Basecamp</p>\n";
              print "					</a>\n";
              print "					</td>\n";
              print "					<td>\n";
              print "					<a href=\"https://ectech.highrisehq.com/account\">\n";
              print "					<div id=\"highrise_logo\" class=\"icon_bg\"></div>\n";
              print "					<p>Highrise</p>\n";
              print "					</a>\n";
              print "					</td>\n";
              print "					<td>\n";
              print "					<a href=\"https://www.input.com/login/loginPage.cfm?\">\n";
              print "					<div id=\"input_logo\" class=\"icon_bg\"></div>\n";
              print "					<p>Input</p>\n";
              print "					</a>\n";
              print "					</td>\n";
              print "					<td>\n";
